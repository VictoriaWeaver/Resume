...
\documentclass[9pt]{article} %Sets the default text size to 11pt and class to article.
%------------------------Dimensions--------------------------------------------
...
\newline
	To obtain a cooperative education position or internship in the field of Computer Engineering or Computer Science for the summer of 2016.
...
\newline
	LED Table- LEDs are connected in a grid with cover of diffused Plexiglass, which is connected to Arduino Uno board and programmed to make various patterns/animations.\\
\newline
	Encryption Algorithm Speeds- RSA and a symmetric key algorithm are implemented in Java and the runtime speeds are used to compare the algorithms.
